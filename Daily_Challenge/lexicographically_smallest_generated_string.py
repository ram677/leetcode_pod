...
# Time complexity: O(n * m) - We iterate through the strings and check for matches.
# Space complexity: O(n + m) - We use an array of size n + m - 1 to store the generated string and a boolean array of the same size to track modifiable positions.